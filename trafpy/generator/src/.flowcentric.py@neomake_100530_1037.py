...
def gen_network_skewness_heat_maps(network, 
    ...
    Assumptions:
        ...
        - Skewness is simply abs((load_rate_per_skewed_node - load_rate_per_non_skewed_node) / max_load_rate_per_node)
    ...
    for load in loads:
        ...
        figs.append(plot_dists.plot_labeled_heat_map(proportion_nodes_skewed, skewed_nodes_traffic_requested, heat_map, 0.05, **kwargs))
